//  ----------------------------------------------------------------------------
//
//  bootstrap-typeahead2.js  
//
//  Twitter Bootstrap Typeahead2 Plugin
//  v1.2.2
//  https://github.com/tcrosen/twitter-bootstrap-typeahead2
//
//
//  Author
//  ----------
...
//  Description
//  ----------
//  Custom implementation of Twitter's Bootstrap Typeahead2 Plugin
//  http://twitter.github.com/bootstrap/javascript.html#typeahead2
//
//
//  Requirements
//  ----------
...
function ($) {
    ...
    var Typeahead2 = function (element, options) {
        ...
        this.options = $.extend(true, {}, $.fn.typeahead2.defaults, options);
        ...
        if (!this.source.length) {
            ...
            if (typeof ajax === 'string') {
                this.ajax = $.extend({}, $.fn.typeahead2.defaults.ajax, { url: ajax });
            } else {
                this.ajax = $.extend({}, $.fn.typeahead2.defaults.ajax, ajax);
            }
    ...
    $.fn.typeahead2 = function (option) {
        return this.each(function () {
            ...
            if (!data) {
                $this.data('typeahead2', (data = new Typeahead2(this, options)));
            }
