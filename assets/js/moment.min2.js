...
(function(a) {
    ...
    mc.DDDD = g(mc.DDD, 3), l(i.prototype, {
        ...
        _months: "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Dicimbre".split("_"),
        months: function(a) {
        ...
        _weekdays: "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split("_"),
        weekdays: function(a) {
            return this._weekdays[a.day()]
        },
        _weekdaysShort: "Dom_Lun_Mar_Mie_Jue_Vie_Sab".split("_"),
        weekdaysShort: function(a) {
            return this._weekdaysShort[a.day()]
        },
        _weekdaysMin: "Do_Lu_Ma_Mi_Ju_Vi_Sa".split("_"),
